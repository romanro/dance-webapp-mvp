(function (factory) {
  if (typeof module === 'object' && typeof module.exports === 'object') {
    ...
    define('@angular/compiler-cli/ngcc/src/execution/lock_file', [
      'require',
      'exports',
      'process',
    ], factory);
  ...
  var LockFile = /** @class */ (function () {
    function LockFile(fs) {
      var _this = this;
      this.fs = fs;
      this.lockFilePath = this.fs.resolve(
        require.resolve('@angular/compiler-cli/ngcc'),
        '../__ngcc_lock_file__'
      );
      /**
      ...
      try {
        ...
        throw new Error(
          'ngcc is already running at process with id ' +
            pid +
            '.\n' +
            ('(If you are sure no ngcc process is running then you should delete the lockfile at ' +
              this.lockFilePath +
              '.)')
        );
      }
